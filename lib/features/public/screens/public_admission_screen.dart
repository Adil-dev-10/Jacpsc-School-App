...
class PublicAdmissionScreen extends StatelessWidget {
  const PublicAdmissionScreen({super.key});
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            // Sticky Action Buttons (Simulated mostly, could be actually sticky with Slivers)
            Padding(
